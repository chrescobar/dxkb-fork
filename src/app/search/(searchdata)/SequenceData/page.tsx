...
export function SequenceData({ onSelectionChange }: GenomeDataProps) {
  const sequenceColumns = Object.values(sequenceFields)
  ...
  const baseURL = `${DataAPI}/genome_sequence/?${cleanQ}`;
  const pageSize = 200;
