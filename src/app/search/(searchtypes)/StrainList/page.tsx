    ...
    return(
        <WithGenomePanel tabs={['strain']}>
          ...
          <Tabs className="h-[85vh]" value={activeTab} onValueChange={setActiveTab} >
            ...
            <TabsContent value="strain" className="border-0 mt-0 px-0 pt-[5px] flex-1 flex flex-col overflow-hidden">
              <ListData resource="strain" q={{q}} onSelectionChange={setSelectedRows} />
            </TabsContent>
          </Tabs>
          )}
        </WithGenomePanel>
