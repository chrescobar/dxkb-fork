import { HorizontalLandingShellClient } from "./horizontal-landing-shell-client";
import type {
...
interface HorizontalLandingShellProps {
...
export function HorizontalLandingShell({
  config,
  views,
  activeViewKey,
}: HorizontalLandingShellProps) {
