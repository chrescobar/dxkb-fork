    ...
    <Dialog>
      <DialogTrigger asChild>
        <Button
          variant="ghost"
          size="icon"
          className="h-5 w-5 rounded-full p-0.5 hover:bg-accent hover:text-accent-foreground hover:cursor-pointer"
        >
      ...
      <DialogContent className="sm:max-w-xl">
        ...
        {sections.length > 0 && (
          <div className="max-h-128 space-y-6 overflow-y-auto rounded-md border bg-white p-4 py-4">
