...
function formatSegmentLabel(segment: string, currentUsername?: string): string {
...
export function WorkspaceBreadcrumbs({
  ...
  const usernameRootHref = username
    ? `/workspace/${encodedUser}`
    : "/workspace";
  const homeBase = username
    ? `/workspace/${encodedUser}/home`
    : "/workspace/home";
    ...
    return (
      ...
      >
        ...
        {segments.map((segment, index) => {
          const segmentPath = buildEncodedSegmentPath(
